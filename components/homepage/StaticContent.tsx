  ...
  return (
    <div className="min-h-screen bg-white relative">
      ...
      <div className="relative bg-white">
            ...
            <div className="text-left mobile-mb-medium">
              ...
              <div className="mb-12">
                ...
                <div className="block lg:hidden text-center space-y-4 sm:space-y-6 p-x-3">
                  <h1 className="text-5xl sm:text-6xl font-bold text-white leading-relaxed text-left">
                    面接の不安
                    <br />
                ...
                <div className="hidden lg:block">
                  ...
                  <div className="flex items-end justify-between">
                    <div className="flex-1">
                      <h1 className="text-6xl lg:text-8xl font-bold text-white mb-0 leading-tight text-left">
                        <span className="text-[#9fe870]">AI面接官</span>
                        で潰せ
                      </h1>
                    </div>
                    ...
                    <div className="flex-shrink-0 mb-2 ml-8">
                      <button
                        id="hero-desktop-button"
              ...
              <p className="text-sm sm:text-base lg:text-xl text-white/80 mobile-mb-large max-w-4xl leading-relaxed text-left">
        ...
        <section className="mobile-section-padding bg-white relative overflow-hidden px-4 sm:px-6 py-6 sm:py-8">
          <div className="mobile-container">
            ...
            <div className="mobile-grid-2 gap-6 lg:gap-20 items-center">
              ...
              <div className="relative flex justify-center items-center min-h-[240px] sm:min-h-[400px] lg:min-h-[600px] order-1 lg:order-1">
        ...
        <section className="w-full flex justify-center items-center py-20 sm:py-24 lg:py-32 bg-transparent mt-8 sm:mt-12 lg:mt-16">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-extrabold text-[#9fe870] text-center mobile-mb-small leading-tight mt-2">
              <span className="block sm:hidden">AI面接官が自信を引き出す</span>
            ...
            <button
              id="transformation-button"
              className="bg-[#9fe870] text-[#163300] w-full sm:w-auto px-6 sm:px-10 py-3 sm:py-4 rounded-full font-semibold text-base sm:text-lg lg:text-xl transition-colors shadow-lg hover:bg-[#8fd960]"
            >
              AI面接を無料で体験する
            </button>
          </div>
        ...
        <section className="mobile-section-padding bg-white relative overflow-hidden px-4 sm:px-6 py-6 sm:py-8">
          <div className="mobile-container relative z-10">
            ...
            <div className="mobile-grid-2 gap-6 sm:gap-8 lg:gap-12 max-w-6xl mx-auto mobile-mb-large">
              ...
              <div className="bg-white rounded-3xl border border-gray-200 overflow-hidden hover:border-gray-300 transition-all duration-300">
                {/* Card Header */}
              ...
              {/* AI Method Card */}
              <div className="bg-white rounded-3xl border-2 border-[#9fe870] overflow-hidden relative">
                {/* Popular Badge */}
      ...
      <footer className="bg-[#163300] text-white relative overflow-hidden">
        {/* Background Pattern */}
